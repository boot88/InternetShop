        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('register') }}" class="text-gray-600 hover:text-primary transition duration-150">
                        Регистрация
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-md w-full mx-auto">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div class="bg-gradient-to-r from-primary to-accent py-6 px-8">
                    ...
                    <p class="text-blue-100 mt-2">Войдите, чтобы продолжить покупки</p>
                </div>
                ...
                <form class="p-8 space-y-6" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm text-primary hover:text-secondary transition duration-150">
                            Забыли пароль?
                        </a>
                    </div>
                    ...
                    <div class="relative my-6">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-white text-gray-500">Или войдите с помощью</span>
                        </div>
                    </div>
                    ...
                    <div class="text-center pt-4">
                        <p class="text-gray-600">
                            Нет аккаунта?
                            <a href="{{ route('register') }}" class="font-medium text-primary hover:text-secondary transition duration-150 ml-1">
                                Зарегистрируйтесь
                            </a>
                        </p>
                    </div>
