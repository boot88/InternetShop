...
<section class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
  ...
  <p class="mt-4 max-w-3xl leading-7 text-slate-600">Порядок зависит от состояния товара, причины обращения и применимых требований законодательства. До отправки товара свяжитесь с магазином и укажите номер заказа.</p>
  <div class="mt-8 grid gap-5 md:grid-cols-3">
    <div class="rounded-2xl bg-white p-5 ring-1 ring-slate-200"><h2 class="font-semibold text-slate-950">Товар надлежащего качества</h2><p class="mt-2 text-sm leading-6 text-slate-600">Сохраните товарный вид, потребительские свойства, комплектность и документы. Мы сообщим порядок и адрес возврата.</p></div>
