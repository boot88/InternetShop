...
class ExtendedProductImagesTableSeeder extends Seeder
{
    public function run()
    {
        ...
        // Keep newly seeded databases independent of Unsplash. Existing
        // databases are handled by ProductImage::getUrl() as well.
        $localImagePaths = [
        ...
        foreach ($images as $image) {
            if ($image['is_main'] && isset($localImagePaths[$image['product_id']])) {
                $image['image_path'] = $localImagePaths[$image['product_id']];
            }
